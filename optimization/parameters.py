...
# TCP_RADIUS_LOW_LEG = 19.302
# TCP_RADIUS_HIGH_LEG = 19.179

mode = 'optimization' 
study_name = 'no-name-b33cf3c0-5860-44cd-8f60-cf545cc2eb69'#'no-name-0bf64242-b698-4c09-b049-46976cf3c0eb'
trial_number = '1925'#'175'
trial_path = os.path.dirname(os.path.realpath(__file__))+'/../results/'+study_name+'/'+trial_number+'/params.json'

# Center part parameters
...
low_leg_control_points = [[[-low_leg_pulley_radius+20, -30-low_leg_pulley_fixture],0.1,90],
                          [[-low_leg_pulley_radius+20, -30],20,90,0.1,270],
                          [[20,20],35,-20],
                          [[low_leg_pulley_radius+low_leg_motor_distance_center-center_part_low_diameter/2+1,low_leg_height-15],0.1,90,20,270],
                          [[low_leg_pulley_radius+low_leg_motor_distance_center-center_part_low_diameter/2+1,low_leg_height],0.1,90]]

high_leg_control_points = [[[-high_leg_pulley_radius+20, -30-high_leg_pulley_fixture_depth],0.1,90],
                           [[-high_leg_pulley_radius+20, -30],20,90,0.1,270],
                           [[50,50],35,-45],
                           [[high_leg_pulley_radius+high_leg_motor_distance_center-center_part_high_diameter/2+1,low_leg_height+center_part_leg_height_difference-15],0.1,90,20,270],
                           [[high_leg_pulley_radius+high_leg_motor_distance_center-center_part_high_diameter/2+1,low_leg_height+center_part_leg_height_difference],0.1,90]]
